...
public class BaseActor extends Group {
	...
	public Animation<TextureRegion> loadAnimationFromFile(String[] fileNames, float frameDuration,
			boolean loop){
	...
	public Animation<TextureRegion> loadAnimationFromSheet(String fileName, int rows,
	...
	public Animation<TextureRegion> loadTexture(String fileName) {
		...
		return loadAnimationFromFile(fileNames, 1, true);
	}
	...
	public void applyPhysics(float dt) {
		...
		//decrase speed (decelerate) when not accelerating
	...
	public void alignCamera() {
		...
		cam.position.set(this.getX() + this.getOriginX(), this.getY()+150 + this.getOriginY()+150, 0);
