...
public class Level3Screen extends BaseScreen{
	...
	public void initialize() {
        ...
        boss = new BossLevel3(0, 600, mainStage);
        boss.setLife(1600);
        ...
        try {
			...
			basePoints = Integer.parseInt(properties.getProperty("actualpoints3"));
		...
		music = Gdx.audio.newMusic(Gdx.files.internal("assets/music/Night Drift.mp3"));
	...
	public void update(float dt) {
        ...
        if(bossDie) {
            ...
            if(points > basePoints) {
            	properties.setProperty("actualpoints3", String.valueOf(points));
            	try {
