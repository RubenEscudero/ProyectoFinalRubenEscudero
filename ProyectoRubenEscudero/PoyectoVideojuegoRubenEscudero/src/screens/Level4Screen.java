...
public class Level4Screen extends BaseScreen{
	...
	public void initialize() {
		...
		music = Gdx.audio.newMusic(Gdx.files.internal("assets/music/Heartbreak4.mp3"));
	...
	/**
	 * Method to create two smalls bullets who attack enemies
	 */
