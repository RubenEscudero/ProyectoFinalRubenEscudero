...
/**
 * Class to play level 5
 * @author ruben
 * @since 22/04/2020
 */
public class Level5Screen extends BaseScreen{
	...
	public void initialize() {
		...
		background.loadTexture("assets/backgrounds/Nebula Red.png");
        ...
        bossThrust = new BaseActor(0, 0, mainStage);
        bossThrust.setAnimation(GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("assets/characters/boss-thrust.gif").read()));
        boss = new BossLevel5(0, 600, mainStage);
        boss.setLife(3800);
        ...
        try {
			...
			basePoints = Integer.parseInt(properties.getProperty("actualpoints5"));
	...
	public void update(float dt) {
        ...
        bossThrust.setX(boss.getX() + 25);
        bossThrust.setY(boss.getY() + 115);
        ...
        if(bossDie) {
            ...
            if(points > basePoints) {
            	properties.setProperty("actualpoints5", String.valueOf(points));
            	try {
	...
	/**
	 * Method to create enemies Enemy2
	 */
	...
	/**
	 * Method to create enemies Enemy3
	 */
	...
	/**
	 * Method to create enemies EnemyKamikaze
	 */
